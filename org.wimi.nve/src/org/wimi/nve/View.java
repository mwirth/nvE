...
public class View extends ViewPart
{
	...
	public void createPartControl(Composite parent)
	{
		...
		// create a table with 2 columns and fill with data
		...
		// column1.pack();
		column2.pack();
		int shellX = parent.getShell().getSize().x;
		int column2Width = column2.getWidth();
		column1.setWidth(shellX - column2Width - 20);
		...
		box.addKeyListener(new KeyListener()
		{
			...
			public void keyPressed(KeyEvent e)
			{
				if (e.keyCode == SWT.ARROW_DOWN)
				{
					...
					System.out.println("selectedRow: " + selectionIndex);
					if (selectionIndex == -1)
					...
					box.setText(selectedText);
					box.setSelection(0, selectedText.length() - 1);
				}
